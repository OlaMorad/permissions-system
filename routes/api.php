...
Route::controller(FormController::class)->group(function () {
    Route::prefix('form')->group(function () {
        ...
        Route::get('/{id}', 'show_Form')->middleware(['auth:api', 'role:رئيس الديوان']);
...
Route::controller(TransactionController::class)->group(function () {
    Route::prefix('transaction')->group(function () {
        ...
        Route::get('content/{uuid}', 'ShowTransactionContent')->middleware('auth:api');
...
Route::get('all_paths', [PathController::class, 'index'])->middleware(['auth:api', 'role:رئيس الديوان']);
